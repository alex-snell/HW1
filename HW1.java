...
public class HW1 {
        ...
        public void removeElementsLT(int ltValue) {
            ...
            if (currNode != null) {
                ...
                while (currNode.next != null) {
                    //Check if data <= to ltValue given
                    if (currNode.data < ltValue || currNode.data == ltValue) {
                        removeElement(currNode.data);
                    }
                    //Continue traversing
    ...
    static class Stacks {
        ...
        public static boolean isPalindrome(String input) {
            ...
            //Create stack with characters
            for (int i = 0; i < input.length(); i++) {
                stack.push(input.charAt(i));
            }
            //Initilize reverse String
            String reverse = "";
            //Store reversed characters in reverse
            for (int i = 0; i < input.length(); i++) {
        ...
        public static int findLargestK(Stack<Integer> stack, int k) {
            ...
            //Initilize found
            boolean found = false;
            //Go through stack data
            while(!stack.isEmpty()){
                //Store in temp variable
                int val = stack.pop();
                //Check if k == val, and that it has not already been found
                if(k == val && found == false){
                    index = stack.size();
                    found = true;
                }
                //Push val into temp stack
                temp.push(val);
            }
            ...
            //Return largest index value of k
            return index;
        }
     ...
     * Algorithm Analysis
     *
     * Below are two methods, algorithmAnalysis1 and algorithmAnalysis2. Modify
     * the return statement to return the correct option number.
     *
     ********************************
     */
